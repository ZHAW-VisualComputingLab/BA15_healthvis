...
function dataProcessingSite6(){
    ...
    // Set dataheadername
    viualizationSite6Options.lineChart.setDataHeaderName(d3.entries(viualizationSite6Options.loadedFile[0]).sort(sortYearsAscNameFirst)[0].key);
    ...
    for(var k = 0; k<viualizationSite6Options.loadedFile.length; k++){
        tempTimeLineName = d3.entries(viualizationSite6Options.loadedFile[k]).sort(sortYearsAscNameFirst)[0].value;
        tempConvertedData = d3.entries(viualizationSite6Options.loadedFile[k]);
